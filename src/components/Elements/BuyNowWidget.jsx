...
const BuyNowWidget = () => {
  ...
  if (location.pathname === '/login' || location.pathname === '/fortune' || location.pathname === '/basket' || location.pathname === '/profile' || location.pathname === '/order' || location.pathname.startsWith('/admin')) {
    return null;
  }
