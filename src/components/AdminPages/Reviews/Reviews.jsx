    ...
    <AdminLayout>
      <div className="admin-reviews">
        <AnimatePresence>
          {toast.message && (
            <motion.div
              className={`admin-reviews__toast ${toast.type === 'error' ? 'admin-reviews__toast--error' : ''}`}
                          ...
                          <AdminTableActions
                            ...
                            actions={[
                              ...
                              },
                              {
                                ...
                                variant: 'danger',
                                locked: !isSuperAdmin,
                                title: isSuperAdmin ? 'Delete Review' : 'Access denied (Super Admin only)',
                                icon: (
                                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="admin-reviews__modal-footer">
                  ...
                  <div className="footer-actions">
                    <button
                      ...
                      title={isSuperAdmin ? 'Delete' : 'Access denied (Super Admin only)'}
                    >
                      {!isSuperAdmin && (
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: '13px', height: '13px', marginRight: '6px', verticalAlign: '-1px' }}>
